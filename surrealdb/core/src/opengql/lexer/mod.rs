//! The GQL lexer.
//!
//! Implements the lexical rules of `doc/opengql/REFERENCE.md` section (a),
//! transcribed from the vendored grammar `doc/opengql/GQL.g4` (sections
...
use crate::opengql::token::{Token, TokenKind, t};
...
pub struct Lexer<'a> {
	...
	pub(in crate::opengql) error: Option<SyntaxError>,
}
