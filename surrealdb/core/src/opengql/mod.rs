//! OpenGQL (ISO/IEC 39075 GQL) front-end for SurrealDB.
//!
...
const TARGET: &str = "surrealdb::core::opengql";
...
#[instrument(level = "trace", target = "surrealdb::core::opengql", fields(length = input.len()))]
